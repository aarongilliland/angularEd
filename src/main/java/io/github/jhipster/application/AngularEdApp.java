...
public class AngularEdApp {

    private static final Logger log = LoggerFactory.getLogger(AngularEdApp.class);

    private final Environment env;

    public AngularEdApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes angularEd.
     * <p>
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(AngularEdApp.class);
